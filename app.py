...
def run():
    ...
    st.markdown("Contributions are welcome! 🎉 Please feel free to raise an issue or submit a PR. 😊")
    st.markdown("This project is under license from MIT. For more details, see the [LICENSE](https://github.com/deepakm12/health-insurance-prediction/blob/main/LICENSE) file.")        
    st.markdown("Made by [Mohd Tarique](https://github.com/Mohd-Tarique99)")
